...
- Add the argument ~breaks=20~ to the ~hist~ function call. Change the
  ...
  #+begin_src R :exports both :session :results output graphics file :file Nile2.png
    hist(Nile, breaks=20)
  #+end_src
...
- Make a new vector by sorting the =len= variable with =sort=
  ...
  : [1]  4.2  5.2  5.8  6.4  7.0  7.3  8.2  9.4  9.7  9.7 10.0 10.0 11.2 11.2 11.5 13.6 14.5
  : [18] 14.5 14.5 15.2 15.2 15.5 16.5 16.5 16.5 17.3 17.3 17.6 18.5 18.8 19.7 20.0 21.2 21.5
  : [35] 21.5 22.4 22.5 23.0 23.3 23.3 23.6 23.6 24.5 24.8 25.2 25.5 25.5 25.8 26.4 26.4 26.4
  : [52] 26.4 26.7 27.3 27.3 29.4 29.5 30.9 32.5 33.9
