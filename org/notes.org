...
** Addendum: The =%in%= operator

- How can you find the average of the average flow of the =Nile= between
  1905 and 1910?
  #+begin_src R
    mean(Nile[time(Nile) %in% 1905:1910])
  #+end_src

- Explanation:
  #+begin_src R
    # find Joe
    "Joe" %in% c("John","Jim","Joe")
    "Joe" %in% c(2,3,4)
    100 %in% 1:100
  #+end_src
...
- The =%in%= operator is more intuitive than its parent =match= function:
  #+begin_src R
    match(100, c(200,100,300))
    match(c(200,300),c(200,100,300))
    match(c(100,200,300),c(200,100,300))
  #+end_src
