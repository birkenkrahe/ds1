...
- Very interesting results! Not everybody understood how the
  application works. You've been sent feedback via Team Chat.

- Please take some time now to add your responses to the podcast in
  the thread below your own Google Chat post (with the .wav file).

- Discuss with your team members what to write, and then briefly
  present your lessons learnt and your view of NotebookLM.

** Vectors in R (continued)

- [ ] Creating vector sequences and repetitions (Monday)
- [ ] Sorting and measuring vector lengths (Wednesday)
- [ ] Lab with practice file (Friday)
