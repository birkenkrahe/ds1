...
** IN PROGRESS DataCamp review: Exploring categorical data (deep dive)

*** DONE Is the =factor= data structure common in data sets?
#+begin_quote
...
*** DONE How can you find out if a variable is (suited to be) a factor?
#+begin_quote
...
*** DONE How can you display the levels of a factor variable in R?
#+begin_quote
...
*** DONE What is the purpose of using factors in R for categorical data analysis?
#+begin_quote
...
*** NEXT Can you give a concrete example for these applications of =factor= data?
