...
- [ ] Bonus exercise with the =islands= dataset
- [ ] New quiz on =data.table= and sub-setting vectors
- [ ] DataCamp review: =data.table=
- [ ] Review: data frames and factors
- [ ] Practice with data frames and factors
- [ ] DataCamp: 4-part EDA series with =dplyr= and =ggplot2=
