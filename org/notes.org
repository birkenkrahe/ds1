...
#+attr_html: :width 600px: 
#+caption: 1940 US Presidential Election (Roosevelt vs Willkie)
[[../img/election.jpg]]

*REMEMBER: NO CLASS MEETING THIS WEEK ON FRIDAY*

- [ ] *Complete* bonus exercise with the =islands= dataset
- [ ] *Complete* new quiz on =data.table= and sub-setting vectors
- [ ] *Review* DataCamp lesson: =data.table=
- [ ] *Code along*: data frames and factors
- [ ] *Practice* with data frames and factors
- [ ] *Complete* in DataCamp: 4-part EDA series with =dplyr= and =ggplot2=

** NEXT DataCamp review: =data.table=
...
3) How would you turn a =data.frame= into a =data.table=?
   ...
   Sepal.Length        Sepal.Width       Petal.Length         Petal.Width
                     <num>              <num>              <num>               <num>
     1: 5.0999999999999996 3.5000000000000000 1.3999999999999999 0.20000000000000001
     2: 4.9000000000000004 3.0000000000000000 1.3999999999999999 0.20000000000000001
     3: 4.7000000000000002 3.2000000000000002 1.3000000000000000 0.20000000000000001
     4: 4.5999999999999996 3.1000000000000001 1.5000000000000000 0.20000000000000001
     5: 5.0000000000000000 3.6000000000000001 1.3999999999999999 0.20000000000000001
    ---                                                                             
   146: 6.7000000000000002 3.0000000000000000 5.2000000000000002 2.29999999999999982
   147: 6.2999999999999998 2.5000000000000000 5.0000000000000000 1.89999999999999991
   148: 6.5000000000000000 3.0000000000000000 5.2000000000000002 2.00000000000000000
   149: 6.2000000000000002 3.3999999999999999 5.4000000000000004 2.29999999999999982
   150: 5.9000000000000004 3.0000000000000000 5.0999999999999996 1.80000000000000004
          Species
           <fctr>
     1:    setosa
     2:    setosa
...
4) How can you use =data.table= to filter rows, select and group by
   ...
   1: 7.0000000000000000 3.2000000000000002 4.7000000000000002 1.3999999999999999 versicolor
   2: 6.4000000000000004 3.2000000000000002 4.5000000000000000 1.5000000000000000 versicolor
   3: 6.9000000000000004 3.1000000000000001 4.9000000000000004 1.5000000000000000 versicolor
   4: 5.5000000000000000 2.2999999999999998 4.0000000000000000 1.3000000000000000 versicolor
   5: 6.5000000000000000 2.7999999999999998 4.5999999999999996 1.5000000000000000 versicolor
   6: 5.7000000000000002 2.7999999999999998 4.5000000000000000 1.3000000000000000 versicolor
   [1] 4.7000000000000002 4.5000000000000000 4.9000000000000004 4.0000000000000000
   [5] 4.5999999999999996 4.5000000000000000
   [1] 5.0021505376344084
   Species                 V1
          <fctr>              <num>
   1: versicolor 4.3627906976744182
   2:  virginica 5.5519999999999996
   Species            Average
          <fctr>              <num>
   1: versicolor 4.3627906976744182
   2:  virginica 5.5519999999999996
...
5) You're handling Terabytes (1,024 GB) or Petabytes (1 mio GigaBytes,
   ...
   - For PB, distributed processing is required. Examples are: Apache
     Spark (Python,Java,R), BigQuery (SQL), or Snowflat (SQL,Python).
   #+end_quote
