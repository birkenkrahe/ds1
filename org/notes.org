...
- [ ] Lecture & codealong: Vectors in R (=plot=, =hist=, =barplot=)
- [ ] Practice file for Founder's Day Friday (no class meeting)
- [ ] Weekend: Quiz 8 on DataCamp and plotting vectors

** DONE Review: vectors and factors
...
** IN PROGRESS Vectors in R (continued)

- [X] Base R
- [X] Base R plotting: Histograms
- [ ] Bar plots, line plots, scatter plots, box plots
...
** TODO Vector lab II (Friday - no class - founder's day convocation)
