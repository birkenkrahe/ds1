...
4. What is the main goal of EDA?
   ...
   Code example:
   #+begin_src R :session *R* :results output :exports both
     summary(df) # statistical summary for
   #+end_src
...
** TODO Introduction to R (with practice file)
[[../img/3_Rlogo.png]]
...
- [ ] R package commands
- [ ] R customization at startup

The practice exercises are on GitHub at: tinyurl.com/intro-R-practice
