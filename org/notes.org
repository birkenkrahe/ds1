...
*** TODO A bit of plotting at the end: barplot, histogram, boxplot
#+attr_html: :width 600px: 
[[../img/barplots_tuscany.png]]

- You've already seen barplots, histograms, scatterplots and boxplots.

- Barplots are a prominent example in the EDA with R DataCamp lesson.

- Their customization is particularly rewarding: the simultaneous
  presence of continuous and discrete variables is interesting.
