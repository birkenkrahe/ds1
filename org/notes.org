...
- [X] Introduction to R
- [ ] Project - using ~app.litmaps.com~ for references
- [ ] Project - analytics is not the same as prediction
- [ ] Project - proposal deadline is Friday 13 Sept 11:59 pm

** TODO Review questions: Introduction to R (1)
...
2. What command would you use to find where R is installed on your
   system?
   #+begin_src bash :results output
     which R
   #+end_src
...
- [ ] R package commands
- [ ] R customization at startup in ~~/.Rprofile~
