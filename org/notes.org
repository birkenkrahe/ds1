...
*** Impromptu lecture: Client-Server Model and Data Science
#+attr_html: :width 700px:
...
*** DataCamp review: Exploring categorical data (deep dive)
...
** DONE Week 14 - EDA: numerical data & visualization [Nov 18]
#+attr_html: :width 600px:
[[../img/scots.png]]
...
Must upload your materials/presentation/notebook or whatever you're
going to use to your shared drive folder.
...
- This practice file is an edited version of parts of that file
  ...
  Download https://tinyurl.com/plots-practice and open in Emacs
...
- Please take 5 minutes to evaluate this course (in Canvas).

- If you submitted any DataCamp assignments late, you need to let me
  know via email or chat otherwise I won't know that you did (with
  course title).

- Are there any graduating seniors in this class? (Graduating *now*)

- Presentation schedule
  #+attr_html: :width 700px: 
  [[../img/presentation_schedule_ds1_fall24.png]]
