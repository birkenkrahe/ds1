...
- [ ] Lecture & codealong: Vectors in R (=plot=, =hist=, =seq=, =rep=)
- [ ] Practice file for Founder's Day Friday (no class meeting)
- [ ] Weekend: Quiz 8 on DataCamp and vectors
...
- Download practice file: [[https://tinyurl.com/vectors-practice-24][tinyurl.com/vectors-practice-24]]
