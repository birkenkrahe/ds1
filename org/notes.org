...
** DONE Vectors and Matrices (DataCamp) popquiz & =NA= extension
...
Example: "Mapping the use of GAI in university"
- [X] Found one podcast in a GDrive (so far)
- [X] Shared notebook with me (it shows up in my dashboard)
- [ ] No link submitted in Canvas (yet)

*Q&A:*
- [ ] Is it OK that the podcast is more about the sources?
- [ ] Should we add more references without commenting?
- [ ] Should we add our first proposal to the notebook?
- [ ] Do we each have to upload a submission?


** TODO "Data Science is not a Science"
#+attr_html: :width 600px: 
[[../img/rant.png]]
...
** NEXT Lecture & DataCamp review as Lab (30 min)
