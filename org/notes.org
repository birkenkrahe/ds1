...
* Week 2 - Infrastructure Injection
...
* Week 3 - DataLab & Data Collection and Storage
...
- [ ] Quiz 2 is live - complete it by Friday September 6, 11:59 PM
...
** NEXT Review: "Preparation, Exploration, Visualization"
...
4. What is the main goal of EDA?
   ...
   and formulate hypotheses, e.g. about correlation, trends, patterns.
   #+end_quote
   Code example:
   #+begin_src R :session *R* :results output :exports both
     summary(mtcars)
...
5. What does Anscombe's quartet illustrate in the context of EDA?
   ...
   #+end_quote
   Code example:
   #+begin_src R :file :session *R* :results file graphics output :exports both

   #+end_src

6. What is 'labeling' in data visualizations, and why is it important?
   #+begin_quote
...
** IN PROGRESS Introduction to data science (lecture)
