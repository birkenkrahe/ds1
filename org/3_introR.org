...
* NEXT R shell: Version and platform
#+NAME: fig:cli-1
...
- Open the R console, either in a dumb or in a smart terminal (=M-x
  shell)=, or in a dedicated R buffer (=*R*=), or in Emacs (=M-x R=).
...
Do this on an R console in a dumb or smart shell:
...
3) Use ~system~ to run =bash= shell commands from inside R:
   ...
   #+RESULTS:
   : 0_overview.org                                  3d_scatterplot.png     syllabus.org
   : 1_infrastructure_DataLab.org                    3_introR.html          syllabus_pdf.org
   : 1_infrastructure_Emacs.org              3_introR.org           test2.R
   : 1_infrastructure_Google_Cloud_Shell.org      3_introR.pdf      testPython.org
   : 1_infrastructure_Google_Cloud_Shell_pdf.org  3_introR_practice.org  test.R
   : 2_datascience.org                       hello.txt              testR2.org
   : 2_datascience_reveal.html               mtcars.png             testR3.org
   : 2_datascience_reveal.org                notes.org              testR.org
   : 2_datascience_reveal_print.org                  Rpractice.org          test.Rout
...
- Package version and R version may be out of synch
