...
You can do one of these three things to get files from GitHub:

- Open the course directory in GitHub, github.com/birkenkrahe/ds1, go
  to the file /org/3_introR_practice.org, open the "raw" version of
  the file, save and open the file in Emacs.

- Open the full URL of the raw file in the Emacs browser =eww= and write
  the buffer to an Org-mode file: [[https://tinyurl.com/intro-R-practice][tinyurl.com/intro-R-practice]].
  
- Use the command-line with =wget=:
  #+begin_src bash :results output :exports both
    wget Rpractice.org https  tinyurl.com/intro-R-practice
