...
|------+---------------------------------------------+-------------------|
|   10 | EDA in R: Categorical data                  |                   |
|------+---------------------------------------------+-------------------|
|   11 | EDA in R: Numerical data                    | 3rd sprint review |
|------+---------------------------------------------+-------------------|
|   12 | EDA in R: Numerical Summaries               |                   |
|------+---------------------------------------------+-------------------|
|   13 | EDA in R: Case study                        |                   |
|------+---------------------------------------------+-------------------|
|   14 | Python for R Users: The Basics              |                   |
|------+---------------------------------------------+-------------------|
|   15 |                                             | 4th sprint review |
|------+---------------------------------------------+-------------------|
